...
public class HelpCommand implements ICommand {
    ...
    private void generateAndSendEmbed(GuildMessageReceivedEvent event) {
        EmbedBuilder builder = new EmbedBuilder().setTitle("A list of all my commands:").setColor(getRandomColor());
        ...
        //TODO: Make permission check to see if the bot can send embeds if not sent plain text
